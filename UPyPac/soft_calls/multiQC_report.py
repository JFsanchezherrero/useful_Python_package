...
def multiQC_module_call(givenList, name, path, option):
    ...
    .. seealso:: This function depends on other BacterialTyper functions called:
        ...
        - :func:`UPyPac.functions.main_functions.printList2file`
        
        - :func:`BacterialTyper.scripts.multiQC_report.multiQC_call`
    
    """
    pathFile = os.path.join(os.path.abspath(path), 'samples.txt')
    
    ## print list to file
    UPyPac_main.printList2file(pathFile, givenList)
...
def multiQC_call(pathFile, name, folder, option):
    ...
    :returns: :func:`UPyPac_sys.system_call` output (OK/FALSE)
        
    .. seealso:: This function depends on other UPyPac functions called:
    
        - :func:`UPyPac_sys.system_call_function`
    ...
    return(UPyPac_sys.system_call(cmd))
